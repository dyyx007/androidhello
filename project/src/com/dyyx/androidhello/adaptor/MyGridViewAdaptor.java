...
public class MyGridViewAdaptor extends BaseAdapter{
    ...
    private static final String TAG = "MyGridViewAdaptor";
    
    public MyGridViewAdaptor(Context context,List<Map>  data){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
    	...
    	Log.i(TAG, "position="+position+",convertView="+convertView+",parent="+parent);
